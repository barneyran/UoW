...
if IsConvergence
    ...
    [flts_r, flts_b] = Dmsc_OSAP_simplify_filters(niter, K);
end
%{
...
%h = waitbar(0, 'Please wait ...');
    ...
    img = double(img);
    img_bayer = Dmsc_OSAP_cfa_Bayer(img);
    ...
    if IsConvergence
        [xh, t] = Dmsc_OSAP_DmscProc_conv(img_bayer, flts_r, flts_b, approx_rank);
    else
        [xh, t] = Dmsc_OSAP_DmscProc_part(img_bayer, flts_r, flts_b, approx_rank);
    end
    img_out=xh/255;
