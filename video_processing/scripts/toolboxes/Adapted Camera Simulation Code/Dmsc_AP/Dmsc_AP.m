...
function [out_pocs] = Dmsc_AP(X, N_iter, T)

% G R
% B G

%%%%% Initial interpolation of the color channels
RGB = double(Dmsc_AP_Interp_EdgeG(X));
...
%
[CA_Rr,CH_Rr,CV_Rr,CD_Rr] = Dmsc_AP_DWT(Rd,h0,h1);
[CA_Gr,CH_Gr,CV_Gr,CD_Gr] = Dmsc_AP_DWT(Gd_R,h0,h1); 
[CA_Bb,CH_Bb,CV_Bb,CD_Bb] = Dmsc_AP_DWT(Bd,h0,h1);
[CA_Gb,CH_Gb,CV_Gb,CD_Gb] = Dmsc_AP_DWT(Gd_B,h0,h1); 
%
Gd_R = Dmsc_AP_InvDWT(CA_Gr, CH_Rr, CV_Rr, CD_Rr, g0,g1);
Gd_B = Dmsc_AP_InvDWT(CA_Gb, CH_Bb, CV_Bb, CD_Bb, g0,g1);
%
...
for iter=1:N_iter, % iterate
   ...
   [CA_R,CH_R,CV_R,CD_R] = Dmsc_AP_DWT(R,h0,h1);
   [CA_G,CH_G,CV_G,CD_G] = Dmsc_AP_DWT(G,h0,h1);
   [CA_B,CH_B,CV_B,CD_B] = Dmsc_AP_DWT(B,h0,h1);
   ...
   R = Dmsc_AP_InvDWT(CA_R, CH_R, CV_R, CD_R, g0, g1);
   B = Dmsc_AP_InvDWT(CA_B, CH_B, CV_B, CD_B, g0, g1);
...
% gg1 = dyadup(g1,2);
% %
% [CAA_R, CHH_R, CVV_R, CDD_R] = Dmsc_AP_DWT(CA_R, hh0, hh1);
% [CAA_G, CHH_G, CVV_G, CDD_G] = Dmsc_AP_DWT(CA_G, hh0, hh1);
% [CAA_B, CHH_B, CVV_B, CDD_B] = Dmsc_AP_DWT(CA_B, hh0, hh1);
% %
% CA_R = Dmsc_AP_InvDWT(CAA_R, CHH_G, CVV_G, CDD_G, gg0, gg1);
% CA_G = Dmsc_AP_InvDWT(CAA_G, CHH_G, CVV_G, CDD_G, gg0, gg1);
% CA_B = Dmsc_AP_InvDWT(CAA_B, CHH_G, CVV_G, CDD_G, gg0, gg1);
% %
% ---------
