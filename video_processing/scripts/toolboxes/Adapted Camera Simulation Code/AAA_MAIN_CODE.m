...
clear all; 
%close all; clc;
% in_path - Contains input images to be processed in simulation (in alphabetical or numerical order).
in_path = '../Caltech USA subset/png/set06_V002_210-310/'; % set up an in and an out path - this is the in path
% out_path - Folder for output cell arrays
out_path = '../Caltech USA subset/pngAfterEdPipeline/set06_V002_210-310'; % output folder to save any modified images
images = dir([in_path '*.png']); % search for images 
