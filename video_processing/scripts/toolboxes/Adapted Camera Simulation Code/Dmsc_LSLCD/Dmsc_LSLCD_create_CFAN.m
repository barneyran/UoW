...
% NOTES: Ed Fry. 2016.09.06
% CREATES GRGB CFA with NOISE. Noise relates to sigma value. 
% Can be directly implemented into simulations.

function [CFAN] = Dmsc_LSLCD_create_CFAN(RGB,sigma)
