...
algs = {
  ...
  'TLL-TFA',          0, clrs(72,:),  '-'
  'denoised_lc(sig=29.9491)_snr03', 0, clrs(73,:),  '--'
  'denoised_lc(sig=29.9491)_snr05', 0, clrs(74,:),  '-'
  'denoised_lc(sig=29.9491)_snr10', 0, clrs(75,:),  '--'
  'denoised_lc(sig=29.9491)_snr20', 0, clrs(76,:),  '-'
  'denoised_lc(sig=29.9491)_snr40', 0, clrs(77,:),  '--'
  'noisy_snr03',                    0, clrs(78,:),  '-'
  'noisy_snr05',                    0, clrs(79,:),  '--'
  'noisy_snr10',                    0, clrs(80,:),  '-'
  'noisy_snr20',                    0, clrs(81,:),  '--'
  'noisy_snr40',                    0, clrs(82,:),  '-'
  'original',                       0, clrs(83,:),  '--'
  };
...
dataNames = {'Usa08'};
exps = exps(1:3);           % select one or more experiment for evaluation
...
for p=1:nPlots
  ...
  disp('Pause in dbEval line 295 because of failing savefig')
  pause 
